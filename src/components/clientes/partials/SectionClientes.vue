...
<template>
  <section class="clientes">
    <div v-for="user in users" :key=user.name class="cliente">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150" class="icone">
        <path data-name="Caminho 1040"
